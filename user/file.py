...
sam.make_withdrawal(90)
sam.display_user_balance()

print("***************")

ellie.make_deposit(3000)
ellie.make_deposit(300)
ellie.make_deposit(300)
ellie.make_withdrawal(200)
ellie.display_user_balance()

print("***************")

max.make_deposit(3000)
max.make_deposit(300)
max.make_withdrawal(100)
max.make_withdrawal(6000)
